...
* Dataset
use "C:\Users\vctrl\Desktop\UGent\Code\Data\LCA_discri\dataset_LCA_female.dta", clear
...
**************** Latent classes
label define LCA_lab2 1 "Natio. + Skin" 2 "Other" 3 "Gender + Ethnoracial" 4 "Multiple ethnoracial" 5 "Single Ethnoracial (Skin)"
label values pred_class LCA_lab2
...
*1.A No control (M1)
**************************************************
logit MentalH ib5.pred_class, or
outreg2 using "M1_women5_LCA.xls", excel replace dec(3) label stats(coef se ci) eform
...
logit MentalH ib5.pred_class ib2.dip_rec agenq ib4.religion_nomis ib0.pandemic ib1.size_area ib4.family_sit i.generation_disc ib3.origin, or
outreg2 using "M2_women5_LCA.xls", excel replace dec(3) label stats(coef se ci) eform

* On check multicolinearity
reg MentalH ib5.pred_class ib2.dip_rec agenq ib4.religion_nomis ib0.pandemic ib1.size_area ib4.family_sit i.generation_disc ib3.origin
vif // no issue
...
logit MentalH ib5.pred_class ib2.dip_rec agenq ib4.religion_nomis ib0.pandemic ib1.size_area ib4.family_sit i.generation_disc ib3.origin ib1.d_discri_num, or
outreg2 using "M3_women5_LCA.xls", excel replace dec(3) label stats(coef se ci) eform

* On check multicolinearity
reg MentalH ib5.pred_class ib2.dip_rec agenq ib4.religion_nomis ib0.pandemic ib1.size_area ib4.family_sit i.generation_disc ib3.origin ib1.d_discri_num
vif // no issue
