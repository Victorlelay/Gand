...
* Dataset
use "C:\Users\vctrl\Desktop\UGent\Code\Data\LCA_discri\data_male_4.dta", clear
...
label define LCA_lab 1 "Multiple ethnoracial" 2 "Single ethnoracial (Skin)" 3 "Natio. + Skin." 4 "Other"
...
reg MentalH ib2.latent_class ib2.dip_rec agenq ib4.religion_nomis ib0.pandemic ib1.size_area ib4.family_sit i.generation_disc ib3.origin
vif // no issue
...
* On check multicolinearity
reg MentalH ib2.latent_class ib2.dip_rec agenq ib4.religion_nomis ib0.pandemic ib1.size_area ib4.family_sit ib30.origine_tous_g2bis ib1.d_discri_num
vif // no issue
