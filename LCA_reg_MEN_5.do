**************************************************
* Regressions and visualization: LCA discrimination // MEN 
* Victor Le Lay
...
* Dataset
use "C:\Users\vctrl\Desktop\UGent\Code\Data\LCA_discri\data_male_5.dta", clear
...
**************** Latent classes
gen latent_class = 99
replace latent_class = 1 if classe_latente == 4
replace latent_class = 2 if classe_latente == 5
replace latent_class = 3 if classe_latente == 3
replace latent_class = 4 if classe_latente == 2
replace latent_class = 5 if classe_latente == 1

label define LCA_lab 1 "Skin + Natio." 2 "Other" 3 "Natio. + Skin." 4 "Accent + Natio." 5 "Multiple Ethnoracial"
...
*1.A No control (M1)
**************************************************
logit MentalH ib1.latent_class, or
outreg2 using "M1_men5_LCA.xls", excel replace dec(3) label stats(coef se ci) eform
...
logit MentalH ib1.latent_class ib2.dip_rec agenq ib4.religion_nomis ib0.pandemic ib1.size_area ib4.family_sit i.generation_disc ib3.origin, or
outreg2 using "M2_men5_LCA.xls", excel replace dec(3) label stats(coef se ci) eform

* On check multicolinearity
reg MentalH ib1.latent_class ib2.dip_rec agenq ib4.religion_nomis ib0.pandemic ib1.size_area ib4.family_sit i.generation_disc ib3.origin
vif // no issue
...
logit MentalH ib1.latent_class ib2.dip_rec agenq ib4.religion_nomis ib0.pandemic ib1.size_area ib4.family_sit i.generation_disc ib3.origin ib1.d_discri_num, or
outreg2 using "M3_men5_LCA.xls", excel replace dec(3) label stats(coef se ci) eform

* On check multicolinearity
reg MentalH ib1.latent_class ib2.dip_rec agenq ib4.religion_nomis ib0.pandemic ib1.size_area ib4.family_sit ib30.origine_tous_g2bis ib1.d_discri_num
vif // no issue
